...
var numberAir = Number(getUrlParameter("air"));
var numberRoom = Number(getUrlParameter("room"));
document.getElementById("numberAir").innerHTML = numberAir;
document.getElementById("numberRoom").innerHTML = numberRoom;
